...
public class ShowGenreAdapter extends RecyclerView.Adapter<ShowGenreAdapter.MyViewHolder> {


    List<ShowGenre> data;
    Context context;

    public ShowGenreAdapter(Context context, List<ShowGenre> data) {
        this.data = data;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_show_genre_activity, parent, false);
